...
public final class CustomDialogBinding implements ViewBinding {
  ...
  private CustomDialogBinding(@NonNull ConstraintLayout rootView, @NonNull Button closeButton,
      @NonNull EditText editText, @NonNull Button successButton) {
  ...
  public static CustomDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomDialogBinding((ConstraintLayout) rootView, closeButton, editText,
          successButton);
    }
